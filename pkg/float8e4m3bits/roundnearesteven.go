...
func roundNearestEven(signBit, exponentBits, mantissaBits uint32,
    ...
    // In the case we're at the mid-pint, we only add 1, if the LSB of the
    ...
    // Result is larger if the input was positive and we added 1,
    // or if the input was negative and we truncated
